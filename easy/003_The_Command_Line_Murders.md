...
```console
total 44
drwxr-xr-x 7 admin admin 4096 Oct  3  2023 .
drwxr-xr-x 3 root  root  4096 Sep 17  2023 ..
drwx------ 3 admin admin 4096 Sep 20  2023 .ansible
-rw------- 1 admin admin   72 Feb 24 10:56 .bash_history
-rw-r--r-- 1 admin admin  220 Aug  4  2021 .bash_logout
-rw-r--r-- 1 admin admin 3526 Aug  4  2021 .bashrc
drwxr-xr-x 3 admin admin 4096 Sep 20  2023 .config
-rw-r--r-- 1 admin admin  807 Aug  4  2021 .profile
drwx------ 2 admin admin 4096 Sep 17  2023 .ssh
drwxr-xr-x 2 admin root  4096 Oct  3  2023 agent
drwxr-xr-x 4 admin admin 4096 Oct  3  2023 clmystery
-rw-r--r-- 1 admin admin    0 Oct  3  2023 mysolution
```

`cd /home/admin/clmystery && ls -la`
```console
total 264
drwxr-xr-x 4 admin admin   4096 Oct  3  2023 .
drwxr-xr-x 7 admin admin   4096 Oct  3  2023 ..
drwxr-xr-x 8 admin admin   4096 Oct  3  2023 .git
-rw-r--r-- 1 admin admin   1073 Oct  3  2023 LICENSE.md
-rw-r--r-- 1 admin admin   2668 Oct  3  2023 README.md
-rw-r--r-- 1 admin admin  13844 Oct  3  2023 cheatsheet.md
-rw-r--r-- 1 admin admin 189042 Oct  3  2023 cheatsheet.pdf
-rw-r--r-- 1 admin admin    146 Oct  3  2023 hint1
-rw-r--r-- 1 admin admin     88 Oct  3  2023 hint2
-rw-r--r-- 1 admin admin    187 Oct  3  2023 hint3
-rw-r--r-- 1 admin admin    183 Oct  3  2023 hint4
-rw-r--r-- 1 admin admin    280 Oct  3  2023 hint5
-rw-r--r-- 1 admin admin    272 Oct  3  2023 hint6
-rw-r--r-- 1 admin admin    329 Oct  3  2023 hint7
-rw-r--r-- 1 admin admin    473 Oct  3  2023 hint8
-rw-r--r-- 1 admin admin   2559 Oct  3  2023 instructions
drwxr-xr-x 5 admin admin   4096 Oct  3  2023 mystery
```
...
`grep "Blue" vehicles`
`grep "L337" vehicles`
`grep -A 5 "L337" vehicles | grep -C 1 -A 4 "Honda" | grep -C 2 "Blue" | grep -B 4 "6'"`
```console
...
`cat memberships/Rotary_Club memberships/Delta_SkyMiles memberships/Museum_of_Bash_History | grep -c "Joe Germuska"`
`3`
